...
echo "$temps_formatted" | rofi -dmenu -font "Hack Nerd Font 11" -p "TEMPERATURAS" -theme $HOME/Scripts/configuracionesRofi/temaTemperaturas.rasi -xoffset 800 -yoffset 350 
